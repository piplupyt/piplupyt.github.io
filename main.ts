...
class TerminalPortfolio {
	...
	private setupContactEasterEgg(): void {
	...
	private launchFireworks(originX: number, originY: number): void {
	...
	private getFireworkLayer(): HTMLElement {
